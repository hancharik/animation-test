...
public class AnimationTest extends JFrame implements Runnable {
    ...
    int frameCount = 0;
    int frameDelay = 20;
    Color miBlue = new Color(60,173,212);
    int sequence = 0;
    int counter = 0;
    int columns = 7;
    ...
    public AnimationTest() {
        ...
        image = tk.getImage(getURL("/images/sprite2.png"));
    ...
    public void gameUpdate() {
        ...
        g2d.setColor(miBlue);//g2d.setColor(Color.BLACK);
        g2d.fill( new Rectangle(0, 0, ScreenWidth-1, ScreenHeight-1) );

        //draw the current frame of animation
        drawFrame(image, g2d, pos.x, pos.y, columns, currentFrame, 64,64);

        g2d.setColor(Color.WHITE);
      //  g2d.drawString("Position: " + pos.x + "," + pos.y, 10, 50);
        g2d.drawString("Animation: " + currentFrame + ", sequence: " + sequence, 10, 70);
                          ...
                          int width, int height)
    {
        ...
        int fy = ((frame / cols) * height) + (height*sequence);
